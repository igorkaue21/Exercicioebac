...
Quando o cliente colocar os dados como <Nome>, <Sobrenome>, <Pais>, <endereco> , <Cidade>, <CEP>, <Telefone> e <Email>
Então sera <concluido o cadastro> do mesmo

Exemplos:
|Nome    |Sobrenome|Pais      | Endereco           |Cidade         |CEP         |Telefone     | Email               |Concluido o Cadastro    |
